...
class Index extends Controller
{
  ...
  public function reponseMsg()
  {
    ...
    if (!empty($postStr))
    {
      ...
      switch($type)
      {
        ...
        //location
        case 'location':$mesEvent->handleLocation($postObj);break;
        //default
        default:$mesEvent->defaultReply($postObj);break;
  ...
  public function handleEvent($postObj)
  {
    ...
    switch($event){
      //关注事件
      case "subscribe":$mesEvent->handleSub($postObj);break;
      //click事件
  ...
  public function handleClick($postObj)
  {
    ...
    {
      //天气查询处理事件
      case 'weather':$mesEvent->handleWeather($postObj);break;
      case 'bind':$mesEvent->structure($postObj);break;
      case 'register':$mesEvent->structure($postObj);break;
      case 'order':$mesEvent->structure($postObj);break;
      case 'pay':$mesEvent->structure($postObj);break;
      case 'myinfo':$mesEvent->structure($postObj);break;
      default:$mesEvent->defaultReply($postObj);break;
